...
class SwitchM3 extends StatelessWidget {
...
class _SwitchPainter extends ToggleablePainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (reaction.status == AnimationStatus.reverse &&
    ...
    if (reaction.status == AnimationStatus.completed) {
      ...
      if (position.status == AnimationStatus.dismissed ||
    ...
    final Color? trackOutlineColor = inactiveTrackOutlineColor == null
        ? null
        : Color.lerp(
            inactiveTrackOutlineColor, Colors.transparent, currentValue);
