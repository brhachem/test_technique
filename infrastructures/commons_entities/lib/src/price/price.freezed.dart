...
abstract class $PriceCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'currency') String? key, String? value});
}
...
class _$_Price implements _Price {
  const _$_Price({@JsonKey(name: 'currency') this.key, this.value});
  ...
  @override
  String toString() {
    return 'Price(key: $key, value: $value)';
  }
...
abstract class _Price implements Price {
  const factory _Price(
      {@JsonKey(name: 'currency') final String? key,
      final String? value}) = _$_Price;
